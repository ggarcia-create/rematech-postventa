...
export function caseDetailHTML(r, user, images) {
  ...
  const adminIntake = can(user, "admin") ? `<section class="case-block admin-only"><h3>ACTUALIZAR DATOS DEL INGRESO</h3><p class="help">Solo visible para Administración. Los demás usuarios verán los datos actualizados automáticamente.</p><form id="admin-intake-form"><div class="technical-form">${field("Número de serie / SN", "serial", r.intake.serial || "")}
